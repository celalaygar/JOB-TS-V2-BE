...
public class ProjectTeamController {
    ...
    @PostMapping
    public Mono<ProjectTeamResponseDTO> create(@RequestBody ProjectTeamsDto dto) {
        return service.create(dto);
    }

    @PutMapping
    public Mono<ProjectTeamResponseDTO> update(@RequestBody ProjectTeamsDto dto) {
        return service.update(dto);
    }

    @PostMapping("/get-team-detail")
    public Mono<ProjectTeamResponseDTO> getById(@RequestBody ProjectTeamsDto dto) {
    ...
    @PostMapping("/invite")
    public Mono<Invitation> inviteUserToTeam(@RequestBody ProjectTeamsInviteUserRequestDto dto) {
